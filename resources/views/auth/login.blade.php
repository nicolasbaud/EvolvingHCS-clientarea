              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" method="post" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                      <input type="password" name="password" class="form-control @error('password') is-invalid @enderror form-control-lg" placeholder="Mot de passe" aria-label="Mot de passe">
                      @error('password')
                        <span class="error invalid-feedback">{{ $message }}</span>
                      @enderror
                    </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="{{ route('register'); }}" class="text-primary text-gradient font-weight-bold">Inscription</a>
                  </p>
                </div>
              </div>
            </div>
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('https://i.imgur.com/0g0h7O9.jpg');
